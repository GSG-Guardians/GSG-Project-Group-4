...
export class Reminder {
  ...
  @OneToOne(() => Debt, (debt) => debt.reminder, {
    nullable: true,
    onDelete: 'CASCADE',
  })
  ...
  @OneToOne(() => Bill, (bill) => bill.reminder, {
    nullable: true,
    onDelete: 'CASCADE',
  })
  ...
  @OneToOne(() => Expense, (expense) => expense.reminder, {
    nullable: true,
    onDelete: 'CASCADE',
  })
  ...
  @OneToOne(() => GroupInvoice, (groupInvoice) => groupInvoice.reminder, {
    nullable: true,
    onDelete: 'CASCADE',
  })
